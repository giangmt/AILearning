...
def print_results(results_dic, results_stats_dic, model, 
    ...
    """    
    # サマリー結果を印刷
    print("\n** Summary of Results for CNN Model Architecture", model.upper(), "**")
    ...
    print("\n** Results Summary - Percentages **")
    print(f"Percentage of Correctly Matched Images: {results_stats_dic['pct_match']:.2f}%")
    print(f"Percentage of Correctly Classified Dogs: {results_stats_dic['pct_correct_dogs']:.2f}%")
    print(f"Percentage of Correctly Classified Dog Breeds: {results_stats_dic['pct_correct_breed']:.2f}%")
